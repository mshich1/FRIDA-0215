...
with open("../llama_results/em_md.txt") as l_in, open("../llama_results/base_sm_md_em.txt") as b_in:
    ...
    x_axis_labels = ["aFRIDA 3B: relative size","aFRIDA 3B: object function","aFRIDA 3B: differences","aFRIDA 3B: objects causing harm",\
                     ...
                     "FRIDA 3B", "LLaMa 3.1 3B instruct"]
    ...
    ax.set_title("Exact match accuracy on data subsets, 3B params")
    fig.tight_layout()
    plt.show()
